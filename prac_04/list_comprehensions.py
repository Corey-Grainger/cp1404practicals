...
lowercase_full_names = [name.casefold() for name in full_names]
...
names_longer_than_11 = [name.split()[1] for name in full_names if len(name) > 11]
print(names_longer_than_11)
